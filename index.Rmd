...
Melodic dictation is a cognitively demanding process that requires students to hear a melody, then without any access to an external reference, write the melody down on paper in a limited time frame.
...
In this first chapter, I introduce the process of melodic dictation and discuss factors that presumably could play a role in taking melodic dictation building off of the work of Gary Karpinski [@karpinskiAuralSkillsAcquisition2000; @karpinskiModelMusicPerception1990]
